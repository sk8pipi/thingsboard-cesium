    ...
    <template #title>
      <div class="flex items-center space-x-4">
        ...
        <div class="flex flex-col">
          ...
          <span class="text-sm">{{ t('tb.user.admin.detail.title') }}</span>
        </div>
      </div>
    </template>
    ...
    <div v-show="tabActiveKey == DetailTabItemEnum.DETAIL.key">
      <div class="space-x-4">
        ...
        <a-button type="primary success" @click="handleEditUser">
          <Icon :icon="'i-clarity:note-edit-line'" />{{ t('tb.user.admin.action.edit') }}
        </a-button>
        <a-button
          type="primary"
          danger
        ...
        <a-button type="primary" danger @click="handleDeleteUser">
          <Icon :icon="'ant-design:delete-outlined'" />{{ t('tb.user.admin.action.delete') }}
        </a-button>
      </div>
      <div class="space-x-4 my-4">
        <a-button @click="handleCopyUserId">
          <Icon :icon="'ant-design:copy-filled'" />
          {{ t('tb.user.admin.action.copyUserId') }}
        </a-button>
      </div>
